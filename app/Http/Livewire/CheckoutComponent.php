...
class CheckoutComponent extends Component
{
    ...
    public function setShippingCharge()
    {
        ...
        {
            $country_1 = Country::where('distance', $this->country)->first()->distance;
            $price_km = Expedition::where('price_km', $this->select_expedition)->first()->price_km;
            $this->shipping_charge = $price_km * $country_1;
        } else {
            session()->flash('message', 'Select country first!');
        }
    }
    ...
    public function render()
    {
        ...
        return view('livewire.checkout-component', ['countries' => Country::orderBY('country','ASC')->get(), 'expeditions' => Expedition::all()])->layout("layouts.base");
    }
}
