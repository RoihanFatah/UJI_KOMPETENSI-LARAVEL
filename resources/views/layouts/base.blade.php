...
<head>
	...
	<title>R-TECH.com | Gaming Marketplace</title>	
...
<body class="home-page home-01 ">
										...
										@if(Auth::user()->utype === 'ADM')
											<li class="menu-item menu-item-has-children parent" >
												...
												<ul class="submenu curency" >
													...
													<li class="menu-item">
														<a title="Manage New Categories" href="{{route('admin.homecategories')}}">Manage Home Category</a>
													</li>
													<li class="menu-item">
				...
				<div class="container">
					<div class="mid-section main-info-area">
						...
						<div class="wrap-logo-top left-section">
							<a href="index.html" class="link-to-home"><img src="{{ asset('assets/images/logo-rtech.png') }}" alt="mercado"></a>
						</div>
	...
	<script src="https://cdn.tiny.cloud/1/0vhhlw7talplxmowwrrwbvwnicc07pv2bfr01haki4l1db57/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script>
    @livewireScripts
